...
LIBS:photoDiode_MDversion-cache
EELAYER 26 0
EELAYER END
$Descr A4 11693 8268
encoding utf-8
...
U 1 1 5BD1DA72
P 5150 3450
F 0 "D1" V 5146 3372 50  0000 R CNN
F 1 "BPW21" V 5055 3372 50  0000 R CNN
F 2 "Package_TO_SOT_THT:TO-5-2_Window" H 5150 3625 50  0001 C CNN
F 3 "http://techwww.in.tu-clausthal.de/site/Dokumentation/Dioden/Fotodioden/BPW21-Fotodiode.pdf" H 5100 3450 50  0001 C CNN
F 4 "BPW21R" H 5150 3450 50  0001 C CNN "Article number"
	1    5150 3450
	0    -1   -1   0   
$EndComp
$Comp
...
U 1 1 5BD1DC83
P 7050 1800
F 0 "#PWR01" H 7050 1650 50  0001 C CNN
...
U 1 1 5BD1DCE3
P 5725 3450
F 0 "#PWR04" H 5725 3200 50  0001 C CNN
F 1 "GND" V 5730 3322 50  0000 R CNN
...
F 1 "0.1uF" V 7189 2300 50  0000 C CNN
F 2 "Capacitors_SMD:C_0805" H 7388 2150 50  0001 C CNN
F 3 "https://nl.farnell.com/wurth-elektronik/885012207016/cap-0-1-f-10v-10-x7r-0805/dp/2534051" H 7350 2300 50  0001 C CNN
F 4 "885012207016" H 7350 2300 50  0001 C CNN "Article number"
	1    7350 2300
	0    -1   -1   0   
$EndComp
Wire Wire Line
...
U 1 1 5BD1ED12
P 7500 2300
F 0 "#PWR02" H 7500 2050 50  0001 C CNN
...
U 3 1 5BE9F1E2
P 7150 2625
F 0 "U1" H 7150 2992 50  0000 C CNN
F 1 "Opamp_Dual_Generic" H 7150 2901 50  0000 C CNN
F 2 "Housings_SOIC:SOIC-8_3.9x4.9mm_Pitch1.27mm" H 7150 2625 50  0001 C CNN
F 3 "https://nl.mouser.com/ProductDetail/Texas-Instruments/OPA2140AID?qs=sGAEpiMZZMvtNjJQt4UgLazUAy7nLwWSG%252bHXmvkwFZI%3d" H 7150 2625 50  0001 C CNN
	3    7150 2625
	1    0    0    -1  
$EndComp
$Comp
...
F 1 "Opamp_Dual_Generic (OPA2140)" H 5983 3505 50  0000 L CNN
...
U 1 1 5BE9F297
P 7050 2925
F 0 "#PWR0101" H 7050 2675 50  0001 C CNN
...
U 1 1 5BE9F44C
P 7150 4225
F 0 "R3" V 7357 4225 50  0000 C CNN
F 1 "R" V 7266 4225 50  0000 C CNN
F 2 "Resistor_SMD:R_0805_2012Metric" V 7080 4225 50  0001 C CNN
...
U 1 1 5BE9F48E
P 6875 4375
F 0 "R4" V 7082 4375 50  0000 C CNN
F 1 "R" V 6991 4375 50  0000 C CNN
...
U 1 1 5BE9FB70
P 6875 4525
F 0 "#PWR0102" H 6875 4275 50  0001 C CNN
...
U 1 1 5BEB286B
P 7050 2125
F 0 "L1" H 7187 2171 50  0000 L CNN
F 1 "Ferrite_Bead" H 7187 2080 50  0000 L CNN
F 2 "Inductor_SMD:L_0805_2012Metric" V 6980 2125 50  0001 C CNN
F 3 "https://nl.farnell.com/murata/blm21bd272sn1l/ferrite-bead-0-8ohm-200ma-0805/dp/1515647" H 7050 2125 50  0001 C CNN
F 4 "BLM21BD272SN1L" H 7050 2125 50  0001 C CNN "Article number"
	1    7050 2125
	1    0    0    -1  
$EndComp
...
U 1 1 5BEB2C09
P 7350 1975
F 0 "C3" V 7098 1975 50  0000 C CNN
F 1 "1.5uF" V 7189 1975 50  0000 C CNN
F 2 "Capacitors_SMD:C_0805" H 7388 1825 50  0001 C CNN
F 3 "https://nl.farnell.com/multicomp/mc0805x155k6r3ct/cap-1-5-f-6-3v-10-x5r-0805/dp/1759410" H 7350 1975 50  0001 C CNN
F 4 "MC0805X155K6R3CT" H 7350 1975 50  0001 C CNN "Article number"
	1    7350 1975
	0    1    1    0   
$EndComp
$Comp
...
U 1 1 5BEB2C87
P 7500 1975
F 0 "#PWR0104" H 7500 1725 50  0001 C CNN
F 1 "GND" H 7505 1802 50  0000 C CNN
F 2 "" H 7500 1975 50  0001 C CNN
F 3 "" H 7500 1975 50  0001 C CNN
	1    7500 1975
	0    -1   -1   0   
$EndComp
Wire Wire Line
