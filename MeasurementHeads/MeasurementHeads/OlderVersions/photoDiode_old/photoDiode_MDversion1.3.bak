...
LIBS:photoDiode_MDversion1.3-cache
EELAYER 29 0
EELAYER END
$Descr A4 11693 8268
encoding utf-8
...
F 1 "180p" V 5764 4375 50  0000 C CNN
F 2 "Capacitors_SMD:C_0805" H 5963 4225 50  0001 C CNN
F 3 "https://de.farnell.com/multicomp/mc0805n181j500ct/kondensator-180pf-50v-5-c0g-np0/dp/1759207" H 5925 4375 50  0001 C CNN
F 4 "Farnell 1759207" H 0   0   50  0001 C CNN "Article number"
	1    5925 4375
	0    1    1    0   
$EndComp
$Comp
...
F 1 "1000k" V 6041 4725 50  0000 C CNN
F 2 "Resistor_SMD:R_0805_2012Metric" V 5855 4725 50  0001 C CNN
F 3 "https://de.farnell.com/walsin/wr08x1004ftl/dickschichtwiderstand-1m-1-150v/dp/2502674" H 5925 4725 50  0001 C CNN
F 4 "Farnell 2502674" H 0   0   50  0001 C CNN "Article number"
	1    5925 4725
	0    -1   -1   0   
$EndComp
Wire Wire Line
...
F 3 "https://de.farnell.com/kemet/c0805j104m5racauto/kondensator-0-1-f-50v-20-x7r-0805/dp/2673150" H 4950 1700 50  0001 C CNN
F 4 "Farnell 2673150" H 4950 1700 50  0001 C CNN "Article number"
	1    4950 1700
	0    -1   -1   0   
$EndComp
Wire Wire Line
...
$EndComp
$Comp
L photoDiode_MDversion1.3-rescue:EMIshield-EMIshield U2
U 1 1 5BD574D7
P 8250 5950
...
F 4 "Farnel 2497717" H 8250 5950 50  0001 C CNN "Article number"
	1    8250 5950
	1    0    0    -1  
$EndComp
$Comp
...
F 3 "https://de.farnell.com/molex/501331-0307/stiftleiste-3pos-1-reihe-1mm/dp/1835977" H 5850 5200 50  0001 C CNN
F 4 "Farnell 1835977" H 5850 5200 50  0001 C CNN "Article number"
	1    5850 5200
	1    0    0    -1  
$EndComp
...
F 4 "595-OPA2140AID" H 0   0   50  0001 C CNN "Article number"
	2    7175 3650
	1    0    0    1   
$EndComp
$Comp
...
F 4 "595-OPA2140AID" H 6025 3550 50  0001 C CNN "Article number"
	1    6025 3550
	1    0    0    -1  
$EndComp
$Comp
...
F 1 "33k" V 7191 3125 50  0000 C CNN
F 2 "Resistor_SMD:R_0805_2012Metric" V 7005 3125 50  0001 C CNN
F 3 "https://de.farnell.com/te-connectivity/crgcq0805f33k/dickschichtwiderstand-33k-1-0805/dp/2861540" H 7075 3125 50  0001 C CNN
F 4 "Farnell 2861540" H 0   0   50  0001 C CNN "Article number"
	1    7075 3125
	0    -1   -1   0   
$EndComp
$Comp
...
F 1 "18k" V 7141 4225 50  0000 C CNN
F 2 "Resistor_SMD:R_0805_2012Metric" V 6955 4225 50  0001 C CNN
F 3 "https://de.farnell.com/panasonic/erj6enf1802v/dickschichtwiderstand-18k-1-0/dp/2303679" H 7025 4225 50  0001 C CNN
F 4 "Farnell 2303679" H 0   0   50  0001 C CNN "Article number"
	1    7025 4225
	0    1    1    0   
$EndComp
Wire Wire Line
...
F 1 "10k" V 6591 3550 50  0000 C CNN
F 2 "Resistor_SMD:R_0805_2012Metric" V 6405 3550 50  0001 C CNN
F 3 "https://de.farnell.com/panasonic/erj6enf1002v/dickschichtwiderstand-10k-1-0/dp/2303654" H 6475 3550 50  0001 C CNN
F 4 "Farnell 2303654" H 6475 3550 50  0001 C CNN "Article number"
	1    6475 3550
	0    -1   -1   0   
$EndComp
...
F 4 "Farnell 2362109" H 6625 3700 50  0001 C CNN "Article number"
	1    6625 3700
	1    0    0    -1  
$EndComp
$Comp
...
F 4 "Farnell 1515647" H 4650 1525 50  0001 C CNN "Article number"
	1    4650 1525
	1    0    0    -1  
$EndComp
...
F 4 "Farnell 1759410" H 4950 1375 50  0001 C CNN "Article number"
	1    4950 1375
	0    1    1    0   
$EndComp
$Comp
...
F 1 "18k" V 5766 3300 50  0000 C CNN
F 2 "Resistor_SMD:R_0805_2012Metric" V 5580 3300 50  0001 C CNN
F 3 "https://de.farnell.com/panasonic/erj6enf1802v/dickschichtwiderstand-18k-1-0/dp/2303679" H 5650 3300 50  0001 C CNN
F 4 "Farnell 2303679" H 0   0   50  0001 C CNN "Article number"
	1    5650 3300
	-1   0    0    1   
$EndComp
...
F 1 "1N4148" H 5225 3575 50  0000 C CNN
F 2 "Diodes_SMD:D_SOD-123" H 5225 3450 50  0001 C CNN
F 3 "https://de.farnell.com/diodes-inc/1n4148w-7-f/schaltdiode-300ma-100v-sod123/dp/1776392" H 5225 3450 50  0001 C CNN
F 4 "Farnell 1776392" H 0   0   50  0001 C CNN "Article number"
	1    5225 3450
	1    0    0    -1  
$EndComp
Wire Wire Line
...
F 1 "1u" V 5064 3075 50  0000 C CNN
F 2 "Capacitors_SMD:C_0805" H 5263 2925 50  0001 C CNN
F 3 "https://de.farnell.com/kemet/c0805c105k4ractu/kondensator-1-f-16v-10-x7r-0805/dp/9227792" H 5225 3075 50  0001 C CNN
F 4 "Farnell 9227792" H 0   0   50  0001 C CNN "Article number"
	1    5225 3075
	0    1    1    0   
$EndComp
Wire Wire Line
...
F 1 "5k" V 6841 4225 50  0000 C CNN
F 2 "Resistor_SMD:R_0805_2012Metric" V 6655 4225 50  0001 C CNN
F 3 "https://de.farnell.com/vishay/crcw08055k00fkta/dickschichtwiderstand-5k-1/dp/2616759" H 6725 4225 50  0001 C CNN
F 4 "Farnell 2616759" H 0   0   50  0001 C CNN "Article number"
	1    6725 4225
	0    1    1    0   
$EndComp
