...
void setup() 
{
  ...
  /* Check if display has flash memory. If so, that this should
     ...
     which was not present on my TFT50 LEON*/
  int location=0;
  
  tft.writeCalibration(location, &_tsMatrix);
  
  tft.readCalibration(location, &_tsMatrix2);

  Serial.println("Calibration matrix in EEPROM");
  Serial.print("Divider: ");Serial.println( _tsMatrix2.Divider);
  Serial.print("An     : ");Serial.println( _tsMatrix2.An);
  Serial.print("Bn     : ");Serial.println( _tsMatrix2.Bn);
  Serial.print("Cn     : ");Serial.println( _tsMatrix2.Cn);
  Serial.print("Dn     : ");Serial.println( _tsMatrix2.Dn);
  Serial.print("En     : ");Serial.println( _tsMatrix2.En);
  Serial.print("Fn     : ");Serial.println( _tsMatrix2.Fn);
