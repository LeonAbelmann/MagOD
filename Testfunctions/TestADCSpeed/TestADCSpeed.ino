/* TestADC */
/* October 2018 */
/* Check if adc is working and maximum datarate
/* Leon Abelmann */
...
float freq_meas = 30; //Measurement frequency in Hz
...
#incuded "src/ADS1115_2.h" // Override Adafruit_ADS1015 with version with increased speed
...
void loop()
{
  ...
  /* check maximum DAC speed of channels */
  Serial.print("Time for adc readout on 100 acquisitions");
  Time_1 = millis();
  for (int i=0; i <= 99; i++){
      adc0 = myadc.ads.readADC_SingleEnded(0);
      /* adc1 = myadc.ads.readADC_SingleEnded(1); */
  ...
  Serial.print("The total time is: "); Serial.println(millis()-Time_1);

  /* Serial.println("Running doMeasurement 100 times"); */
  /* Time_1 = millis(); */
  /* for (int i=0; i <= 99; i++){ */
  /*   processButtonPress(); */
  /*   doMeasurement(); */
  /*   /\* Check if it is time to go to the next step in the measurement loop *\/ */
  /* if (((millis() - Time_1) > (Switching_time[Looppar_1]-1)) && (Exit_program_1 == LOW)) */
  /*   { */
  /*   } */
  /* } */
  /* Serial.print("The total time is: "); Serial.println(millis()-Time_1); */
  ...
  /*   { Serial.print("Trigger at: "); Serial.println(millis()); */
